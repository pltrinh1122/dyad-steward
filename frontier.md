...
- ◔ **[IN_REVIEW]** `execute_directory_commit_reflection` — EXECUTE: bake the weekly commit-count recruitment signal into the Commons directory  ⟵ probe_directory_activity_reflection, plan_directory_autogen
...
- ○ **[READY]** [PROBE] `probe_delegate_platform_dyad` — PROBE: delegate platform-engineering to a dyad-commons-platform so steward focuses on operating?
...
- ✓ **[DONE]** [PROBE] `probe_csi_guards_armed` — PROBE: are CSI guards implemented as mechanical TRAPS (not just runnable)?
- ✓ **[DONE]** [PROBE] `probe_csi_spaor_traversal` — PROBE: should SPAOR traversal edges be deterministic CSI traps?
