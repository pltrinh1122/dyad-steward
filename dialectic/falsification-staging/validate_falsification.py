#!/usr/bin/env python3
# STAGED FOR THE COMMONS — install path: the-dyad-practice/scripts/validate_falsification.py
# Authored by dyad-steward; the Commons install (+ a CI workflow on PRs to falsification/) is
# Founding-gated, like validate_registry / auto-merge-registration. Proven here first (dogfooded on
# the genesis contest in ./example) before it is proposed to the Commons.
#
# Enforces the v3 contract (dialectic/falsification-contract.md) on a falsification/ ledger:
