...
**local delta** in our `CLAUDE.md` §DFD. Commons owns the general recipe; each dyad owns its
specialization.
...
(the field-set) · `kb/dfd.md` (the n=5 ledger) · `DIRECTORY.md` (the Joining gate) · `CLAUDE.md` §DFD
